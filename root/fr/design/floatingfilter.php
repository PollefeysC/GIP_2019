<form method="GET" id="filter" action="../shop/">
    ...
    <label><input type='radio' checked id='filter2' name='filtercategory' value='0'> Tout</label><br>
...
if ($connect1->connect_error) {
    ...
    $sql = "SELECT category_id, c_name_fr FROM category;";
...
if ($qresult->num_rows > 0) {
    ...
    if (isset($_GET['filtercategory']) && $_GET['filtercategory'] == $endresult['category_id']) {
        echo "<label><input type='radio' checked id='filter2' name='filtercategory' value='".$endresult["category_id"]."'> ".$endresult["c_name_fr"]."</label><br>";

    } else {
        echo "<label><input type='radio' id='filter2' name='filtercategory' value='".$endresult["category_id"]."'> ".$endresult["c_name_fr"]."</label><br>";
    }
    }
}
...
<input type="submit" value="Filtrer" id="filter" name="submitfilter">
</form>