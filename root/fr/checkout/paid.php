...
if (isset($_POST['paid']) && isset($_POST['total'])) {
    ...
    if ($connect1->connect_error) {
        ...
        echo "<h3 id='auth'>Merci pour votre achat! Votre commande a &eacute;t&eacute; re&ccedil;ue</h3>";
    }

} else {
    include("../design/nav.php");
    echo "<h3 id='nonauth'>Demande non authentifi&eacute;e, veuillez retourner au check-out</h3>";
}
