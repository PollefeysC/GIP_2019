...
<?php 
    ...
    if (isset($_SESSION["login"])) {
            ...
            <input id='winkelwagenbutton' type='submit' value='+ Add To Cart'> <br>
            </form>";
    } else {
        echo "  <form action='script.php' method='POST'>
        <input type='text' name='productID' value='".$product_id."' id='invisProductID'>
        <input id='winkelwagenbutton' disabled='disabled' type='submit' value='+ Add To Cart'> <br>
        </form>
        <p id='red'>Add To Cart is only available when you are logged in</p>
        ";
    }
