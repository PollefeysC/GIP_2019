...
<?php 
    ...
    echo "<tfoot>";
    echo "  <tr>
                <th colspan='2'>Total (delivery free on orders over &euro;50)</th>
                <td>&euro;".number_format($total,2)."</td>
            </tr>
            <tr>
                <td colspan='3' id='checkouttd'><a id='checkout' href='../checkout'>Check Out</a></td>
            </tr>
    ...
    echo "<h2>You don't have any products in your shopping cart</h2>";
}
