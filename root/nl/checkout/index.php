...
<?php 
    ...
    Totaal van alle producten: <span>&euro;".number_format($total,2)."</span>
    ...
    if (isset($_GET['code'])) {
        ...
        if ($qresult2->num_rows > 0) {
            ...
            echo "<form name='form' method='GET'><input onchange='form.submit()' placeholder='Kortingscode' type='text' id='code' name='code'></form>";
        }
    ...
    ";
    if ($total >= 50) {
        echo "<span id='gratis'>Gratis</span>";
    } else {
    ...
    Uiteindelijke prijs: <span>&euro;".number_format($total,2)."</span>

    ";?>
</div>
<div id='confirmcheckout' class='checkoutbox'>
<h3>Checkout Confirmatie</h3>
...
<form name='form' action='paid.php' method='POST'>
    <input type='submit' name='paid' id='pay' value='Betaal'>
...
<?php 
    ...
    echo "<h1>Je hebt geen producten in je winkelkar</h1>";
}
