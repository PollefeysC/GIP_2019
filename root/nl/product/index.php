...
<?php 
    ...
    if (isset($_SESSION["login"])) {
            ...
            <input id='winkelwagenbutton' type='submit' value='+ In Winkelkar'> <br>
            </form>";
    } else {
        echo "  <form action='script.php' method='POST'>
        <input type='text' name='productID' value='".$product_id."' id='invisProductID'>
        <input id='winkelwagenbutton' disabled='disabled' type='submit' value='+ In Winkelkar'> <br>
        </form>
        <p id='red'>Toevoegen aan winkelkar is enkel toegestaan als u ingelogd bent</p>
        ";
    }
